...
public class Main {
    ...
    public static String calc(String input) {
        ...
        if(strings.length != 3){
            System.out.println("неккоректно введёная строчка");
            System.exit(0);
        }
        ...
        try {
            ...
            if (number_1 < 1 || number_1 > 10 || number_2 < 1 || number_2 > 10) {
                System.out.println(" Арабские числа не входят в дипозон [1,10]");//исключение, т.к. числа не входят в диапозон [1, 10]
                System.exit(0);
            } else {
                switch (operator) {
                    ...
                    case "/" -> result = number_1 / number_2;
                    default -> {
                        System.out.println(" арифметический знак не явл. +/-/*//"); //завершить работу программы
                        System.exit(0);
                    }
                }
            }
            ...
            switch(stNumber_1){
                ...
                case "X" -> number_1=10;
                default -> {
                    System.out.println(" это не римское число в диапозоне [1, 10]!");
                    System.exit(0);
                }
            } switch(stNumber_2){
                case "I" -> number_2=1;
                ...
                case "X" -> number_2=10;
                default -> {
                    System.out.println(" это не римское число!");
                    System.exit(0);
                }
            }
            ...
            switch (operator) {
                ...
                case "/" -> result = number_1 / number_2;
                default -> {
                    System.out.println("арифметический знак не явл. +/-/*//");
                    System.exit(0);
                }
            }
            if (result < 1) {
                System.out.println(" римские числа не могут быть <1");
                System.exit(0);
            }
